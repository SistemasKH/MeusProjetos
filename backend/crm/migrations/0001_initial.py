    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentesco_do_responsavel', models.CharField(choices=[('F', 'Filho'), ('N', 'Neto'), ('I', 'Irmão'), (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regime_contratacao', models.CharField(blank=True, choices=[('CLT', 'CLT'), ('PJ', 'PJ'), ('FREE', 'Free Lance'), (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_conjuge', models.CharField(blank=True, max_length=100, null=True, verbose_name='Cônjuge')),
                ('naturalidade', models.CharField(blank=True, max_length=100, null=True, verbose_name='Naturalidade')),
                ('parentesco_do_responsavel', models.CharField(choices=[
                 ('F', 'Filho'), ('N', 'Neto'), ('I', 'Irmão'), ('O', 'Outro')], max_length=1, verbose_name='Parentesco do Responsável')),
                ('dependente_convenio_medico', models.CharField(blank=True, max_length=100, null=True, verbose_name='Convênio')),
                ('dependente_contato_fone_convenio', models.CharField(
                    blank=True, max_length=20, null=True, verbose_name='Telefone Convênio')),
                ('dependente_contato_endereco_convenio', models.CharField(
