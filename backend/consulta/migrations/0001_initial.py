    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultas', to='crm.dependente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consulta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pos_consultas', to='consulta.consulta')),
            ],
        ),
        migrations.CreateModel(
            name='Medicamento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_insulina', models.CharField(blank=True, choices=[('1', 'Lantus'), ('2', 'NovoRapid')], max_length=30, null=True, verbose_name='Tipo da Insulina')),
                ('qt_insulina', models.IntegerField(default=0, verbose_name='Quant. aplicada')),
                ('observacao', models.TextField(blank=True, null=True, verbose_name='Observação')),
                ('media_diaria', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='Media Diária')),
                ('media_mensal', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='Media Mensal')),
                ('cuidador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Cuidador', to='crm.cuidador', verbose_name='Cuidador')),
                ('dependente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.dependente', verbose_name='Dependente')),
                ('responsavel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Responsavel', to='crm.responsavel', verbose_name='Responsável')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qt_horas_presentes', models.DecimalField(decimal_places=2, default=0, max_digits=4, verbose_name='Quant. horas')),
                ...
                ('observacao', models.TextField(blank=True, null=True, verbose_name='Observação')),
                ('responsavel_monitoramento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responsavel_monitoramento', to='crm.responsavel', verbose_name='Resp. Monitoramento')),
                ('responsavel_presencial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responsavel_presencial', to='crm.responsavel', verbose_name='Resp. Presencial')),
            ],
            options={
